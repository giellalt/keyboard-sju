.. -*- mode: rst -*-
==========================================
 Keyboards for the Ume Sami language
==========================================

This directory contains source files and build instructions for developing
keyboards for the Ume Sami language. The data and implementations
...
* http://giellatekno.uit.no/sjudoc/index.html
* https://giellalt.uit.no/tools/docu-sju-manual.html
...
The Ume Sami keyboard sources can be acquired using the `Giella SVN
